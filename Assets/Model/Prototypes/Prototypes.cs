...
public static class Prototypes
{
    ...
    private static void CreateProjectilePrototypes()
    {
        ...
        Projectiles.Add(new Projectile("FreezerProjectile", 10, projectile => projectile.Target.Speed = Mathf.Max(projectile.Target.Speed - 1, 1)));
    }
    ...
    private static void CreateBuildingPrototypes()
    {
        ...
        Buildings.Add(new Building("Turret", 1, 0, false, 1f,
            b =>
            {
                var enemyInRange = World.Current.Enemies.FirstOrDefault(e => b.Tile.TilesInRange(4).Contains(e.Tile));
                if (enemyInRange != null)
                {
                    World.Current.CreateProjectile(Prototypes.Projectiles.Get("TurretProjectile"), b.Tile, enemyInRange);
                };
            }));
        Buildings.Add(new Building("Freezer", 1, 0, false, 1f,
            b =>
            {
                var enemyInRange = World.Current.Enemies.FirstOrDefault(e => b.Tile.TilesInRange(5).Contains(e.Tile));
                if (enemyInRange != null)
                {
                    World.Current.CreateProjectile(Prototypes.Projectiles.Get("FreezerProjectile"), b.Tile, enemyInRange);
                };
            }));
    ...
    private static void CreateJobPrototypes()
    {
        ...
        Jobs.Add(new Job("Gather",
            job =>
            {
                ...
                World.Current.CreateBuilding(Prototypes.Buildings.Get("Tree"), World.Current.Tiles[Random.Range(0, 50), Random.Range(0, 50)]);
